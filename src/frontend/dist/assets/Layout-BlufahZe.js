...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, b as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, d as RequestStatusResponseStatus, U as UnknownError, e as RequestStatusDoneNoReplyErrorCode, f as RejectError, g as CertifiedRejectErrorCode, h as UNREACHABLE_ERROR, I as InputError, i as InvalidReadStateRequestErrorCode, k as ReadRequestType, m as Principal, n as IDL, o as MissingCanisterIdErrorCode, H as HttpAgent, p as encode, Q as QueryResponseStatus, q as UncertifiedRejectErrorCode, s as isV3ResponseBody, t as isV2ResponseBody, v as UncertifiedRejectUpdateErrorCode, w as UnexpectedErrorCode, x as decode, y as Subscribable, z as pendingThenable, A as resolveEnabled, B as shallowEqualObjects, D as resolveStaleTime, F as noop, G as environmentManager, J as isValidTimeout, K as timeUntilStale, L as timeoutManager, N as focusManager, O as fetchState, V as replaceData, W as notifyManager, X as hashKey, Y as getDefaultState, r as reactExports, Z as shouldThrowError, _ as useQueryClient, $ as useInternetIdentity, a0 as createActorWithConfig, j as jsxRuntimeExports, R as React, a1 as clsx, c as cn, a2 as o, a3 as vt, a4 as Variant, a5 as Record, a6 as Vec, a7 as Opt, a8 as Service, a9 as Func, aa as Nat, ab as Text, ac as Null, ad as Int, ae as Principal$1, af as Bool, ag as useRouterState, ah as Link } from "./index-BYoSv118.js";
...
function useAuth() {
  ...
  const principalId = isAuthenticated ? identity == null ? void 0 : identity.getPrincipal().toText() : void 0;
  const status = isInitializing ? "initializing" : isAuthenticated ? "authenticated" : "anonymous";
  return {
    isAuthenticated,
    isInitializing,
    loginStatus: status,
...
const CareerPathId = Nat;
const IndustrySector = Variant({
  "healthcare": Null,
  "finance": Null,
  "social": Null,
  "creative": Null,
...
const LearningStyle = Variant({
  "handson": Null,
  "auditory": Null,
  "readingWriting": Null,
  "visual": Null
});
const InterestCategory = Variant({
  "healthcare": Null,
  "social": Null,
  "arts": Null,
  "education": Null,
...
const SkillGap = Record({
  "missing": Vec(Text),
  "acquired": Vec(Text),
  "required": Vec(Text)
});
const SaveProfileRequest = Record({
  "experienceLevel": SkillLevel,
  "learningStyle": LearningStyle,
  "displayName": Text,
  "interests": Vec(InterestCategory),
...
const ToggleMilestoneRequest = Record({
  "completed": Bool,
  "milestoneId": MilestoneId
});
Service({
  "addAcquiredSkill": Func([CareerPathId, Text], [], []),
  "getCareer": Func([CareerPathId], [Opt(CareerPath)], ["query"]),
  "getCareerRecommendations": Func([], [Vec(CareerMatch)], ["query"]),
  "getMyProfile": Func([], [Opt(UserProfilePublic)], ["query"]),
  "getMyProgress": Func([], [Opt(UserProgress)], ["query"]),
  "getProgressSummary": Func([], [Opt(ProgressSummary)], ["query"]),
  "getResources": Func(
    [Vec(ResourceId)],
    [Vec(LearningResource)],
    ["query"]
  ),
  "getResourcesBySkill": Func(
    [Text],
    [Vec(LearningResource)],
    ["query"]
  ),
  "getRoadmap": Func([CareerPathId], [Vec(Milestone)], ["query"]),
  "getSkillGap": Func([CareerPathId], [SkillGap], ["query"]),
  "listCareers": Func([], [Vec(CareerPath)], ["query"]),
  "retakeAssessment": Func([], [], []),
  "saveMyProfile": Func([SaveProfileRequest], [UserProfilePublic], []),
  "selectCareer": Func([Nat], [], []),
  "toggleMilestone": Func([ToggleMilestoneRequest], [UserProgress], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const CareerPathId2 = IDL2.Nat;
  const IndustrySector2 = IDL2.Variant({
    ...
    "tech": IDL2.Null,
    "education": IDL2.Null,
    "engineering": IDL2.Null,
    "business": IDL2.Null,
    "science": IDL2.Null
  });
  const SalaryRange2 = IDL2.Record({
    "max": IDL2.Nat,
    "min": IDL2.Nat,
    "currency": IDL2.Text
  });
  const CareerPath2 = IDL2.Record({
    "id": CareerPathId2,
    "title": IDL2.Text,
    "description": IDL2.Text,
    "sector": IndustrySector2,
    "interestTags": IDL2.Vec(IDL2.Text),
    "salaryRange": SalaryRange2,
    "requiredSkills": IDL2.Vec(IDL2.Text)
  });
  const CareerMatch2 = IDL2.Record({
    "matchScore": IDL2.Nat,
    "career": CareerPath2
  });
  ...
  const LearningStyle2 = IDL2.Variant({
    "handson": IDL2.Null,
    "auditory": IDL2.Null,
    "readingWriting": IDL2.Null,
    "visual": IDL2.Null
  });
  const InterestCategory2 = IDL2.Variant({
    "healthcare": IDL2.Null,
    "social": IDL2.Null,
    "arts": IDL2.Null,
    "education": IDL2.Null,
    "engineering": IDL2.Null,
    "technology": IDL2.Null,
    "business": IDL2.Null,
    "science": IDL2.Null
  });
  const UserId2 = IDL2.Principal;
  const AssessmentAnswer2 = IDL2.Record({
    "answer": IDL2.Text,
    "questionId": IDL2.Nat
  });
  const Timestamp2 = IDL2.Int;
  const UserProfilePublic2 = IDL2.Record({
    "experienceLevel": SkillLevel2,
    "learningStyle": LearningStyle2,
    "selectedCareerPathId": IDL2.Opt(CareerPathId2),
    "displayName": IDL2.Text,
    "interests": IDL2.Vec(InterestCategory2),
    "userId": UserId2,
    "answers": IDL2.Vec(AssessmentAnswer2),
    "createdAt": Timestamp2,
    "updatedAt": Timestamp2,
    "currentSkills": IDL2.Vec(IDL2.Text)
  });
  const MilestoneId2 = IDL2.Nat;
  const UserProgress2 = IDL2.Record({
    "startedAt": Timestamp2,
    "completedCourses": IDL2.Vec(IDL2.Text),
    "userId": UserId2,
    "completedMilestones": IDL2.Vec(MilestoneId2),
    "careerPathId": CareerPathId2,
    "acquiredSkills": IDL2.Vec(IDL2.Text),
    "updatedAt": Timestamp2
  });
  const ProgressSummary2 = IDL2.Record({
    "completedCount": IDL2.Nat,
    "timelineEstimate": IDL2.Text,
    "totalMilestones": IDL2.Nat,
    "nextMilestoneId": IDL2.Opt(MilestoneId2),
    "careerTitle": IDL2.Text,
    "percentComplete": IDL2.Nat
  });
  ...
  const ResourceType2 = IDL2.Variant({
    "video": IDL2.Null,
    "documentation": IDL2.Null,
    "article": IDL2.Null,
    "course": IDL2.Null
  });
  const LearningResource2 = IDL2.Record({
    "id": ResourceId2,
    "url": IDL2.Text,
    "title": IDL2.Text,
    "source": IDL2.Text,
    ...
    "estimatedDuration": IDL2.Text
  });
  const Milestone2 = IDL2.Record({
    "id": MilestoneId2,
    "title": IDL2.Text,
    "order": IDL2.Nat,
    "projects": IDL2.Vec(IDL2.Text),
    "careerPathId": CareerPathId2,
    "description": IDL2.Text,
    "resourceIds": IDL2.Vec(ResourceId2),
    "requiredSkills": IDL2.Vec(IDL2.Text),
    "estimatedTime": IDL2.Text
  });
  const SkillGap2 = IDL2.Record({
    "missing": IDL2.Vec(IDL2.Text),
    "acquired": IDL2.Vec(IDL2.Text),
    "required": IDL2.Vec(IDL2.Text)
  });
  const SaveProfileRequest2 = IDL2.Record({
    "experienceLevel": SkillLevel2,
    "learningStyle": LearningStyle2,
    "displayName": IDL2.Text,
    "interests": IDL2.Vec(InterestCategory2),
  ...
  const ToggleMilestoneRequest2 = IDL2.Record({
    "completed": IDL2.Bool,
    "milestoneId": MilestoneId2
  });
  return IDL2.Service({
    "addAcquiredSkill": IDL2.Func([CareerPathId2, IDL2.Text], [], []),
    "getCareer": IDL2.Func([CareerPathId2], [IDL2.Opt(CareerPath2)], ["query"]),
    "getCareerRecommendations": IDL2.Func(
      [],
      [IDL2.Vec(CareerMatch2)],
      ["query"]
    ),
    "getMyProfile": IDL2.Func([], [IDL2.Opt(UserProfilePublic2)], ["query"]),
    "getMyProgress": IDL2.Func([], [IDL2.Opt(UserProgress2)], ["query"]),
    "getProgressSummary": IDL2.Func([], [IDL2.Opt(ProgressSummary2)], ["query"]),
    "getResources": IDL2.Func(
      [IDL2.Vec(ResourceId2)],
      [IDL2.Vec(LearningResource2)],
      ["query"]
    ),
    "getResourcesBySkill": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(LearningResource2)],
      ["query"]
    ),
    "getRoadmap": IDL2.Func([CareerPathId2], [IDL2.Vec(Milestone2)], ["query"]),
    "getSkillGap": IDL2.Func([CareerPathId2], [SkillGap2], ["query"]),
    "listCareers": IDL2.Func([], [IDL2.Vec(CareerPath2)], ["query"]),
    "retakeAssessment": IDL2.Func([], [], []),
    "saveMyProfile": IDL2.Func([SaveProfileRequest2], [UserProfilePublic2], []),
    "selectCareer": IDL2.Func([IDL2.Nat], [], []),
    "toggleMilestone": IDL2.Func([ToggleMilestoneRequest2], [UserProgress2], [])
  });
};
...
class Backend {
  ...
  async addAcquiredSkill(arg0, arg1) {
  ...
  async getResourcesBySkill(arg0) {
    if (this.processError) {
      try {
...
function from_candid_CareerMatch_n7(_uploadFile, _downloadFile, value) {
  return from_candid_record_n8(_uploadFile, _downloadFile, value);
}
function from_candid_CareerPath_n2(_uploadFile, _downloadFile, value) {
  return from_candid_record_n3(_uploadFile, _downloadFile, value);
}
function from_candid_Difficulty_n28(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n13(_uploadFile, _downloadFile, value);
}
function from_candid_IndustrySector_n4(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n5(_uploadFile, _downloadFile, value);
}
function from_candid_InterestCategory_n18(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n19(_uploadFile, _downloadFile, value);
}
function from_candid_LearningResource_n26(_uploadFile, _downloadFile, value) {
  return from_candid_record_n27(_uploadFile, _downloadFile, value);
}
function from_candid_LearningStyle_n14(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n15(_uploadFile, _downloadFile, value);
}
function from_candid_ProgressSummary_n22(_uploadFile, _downloadFile, value) {
  return from_candid_record_n23(_uploadFile, _downloadFile, value);
}
function from_candid_ResourceType_n29(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n30(_uploadFile, _downloadFile, value);
}
function from_candid_SkillLevel_n12(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n13(_uploadFile, _downloadFile, value);
}
function from_candid_UserProfilePublic_n10(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n15(_uploadFile, _downloadFile, value) {
  return "handson" in value ? "handson" : "auditory" in value ? "auditory" : "readingWriting" in value ? "readingWriting" : "visual" in value ? "visual" : value;
}
function from_candid_variant_n19(_uploadFile, _downloadFile, value) {
  return "healthcare" in value ? "healthcare" : "social" in value ? "social" : "arts" in value ? "arts" : "education" in value ? "education" : "engineering" in value ? "engineering" : "technology" in value ? "technology" : "business" in value ? "business" : "science" in value ? "science" : value;
}
function from_candid_variant_n30(_uploadFile, _downloadFile, value) {
  return "video" in value ? "video" : "documentation" in value ? "documentation" : "article" in value ? "article" : "course" in value ? "course" : value;
}
function from_candid_variant_n5(_uploadFile, _downloadFile, value) {
  return "healthcare" in value ? "healthcare" : "finance" in value ? "finance" : "social" in value ? "social" : "creative" in value ? "creative" : "tech" in value ? "tech" : "education" in value ? "education" : "engineering" in value ? "engineering" : "business" in value ? "business" : "science" in value ? "science" : value;
}
function from_candid_vec_n17(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_InterestCategory_n18(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n25(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_LearningResource_n26(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n31(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_CareerPath_n2(_uploadFile, _downloadFile, x2));
}
function from_candid_vec_n6(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_CareerMatch_n7(_uploadFile, _downloadFile, x2));
}
function to_candid_InterestCategory_n39(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n40(_uploadFile, _downloadFile, value);
}
function to_candid_LearningStyle_n36(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n37(_uploadFile, _downloadFile, value);
}
function to_candid_SaveProfileRequest_n32(_uploadFile, _downloadFile, value) {
  return to_candid_record_n33(_uploadFile, _downloadFile, value);
}
function to_candid_SkillLevel_n34(_uploadFile, _downloadFile, value) {
...
function to_candid_vec_n38(_uploadFile, _downloadFile, value) {
  return value.map((x2) => to_candid_InterestCategory_n39(_uploadFile, _downloadFile, x2));
}
...
function callMethod(actor, method, ...args) {
...
function useCareerPath(careerId) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
function ProgressBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("w-full", className), children: [
    (showLabel || label) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
      label && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-muted-foreground", children: label }),
      showLabel && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold text-foreground tabular-nums", children: [
        clamped,
        "%"
      ] })
    ] }),
...
const navItems = [
  { to: "/", label: "Home", icon: House, ocid: "sidebar.home_link" },
  {
    to: "/assessment",
    label: "Assessment",
    icon: ClipboardList,
...
function Sidebar({ className }) {
  var _a2, _b2;
  const { isAuthenticated, isInitializing, principalId, login, logout } = useAuth();
  const { data: progress } = useUserProgress();
  const router = useRouterState();
  const currentPath = router.location.pathname;
  const milestoneCount = ((_a2 = progress == null ? void 0 : progress.milestoneProgress) == null ? void 0 : _a2.length) ?? 0;
  const completedCount = ((_b2 = progress == null ? void 0 : progress.milestoneProgress) == null ? void 0 : _b2.filter((m) => m.completed).length) ?? 0;
  const progressPct = milestoneCount > 0 ? Math.round(completedCount / milestoneCount * 100) : 0;
    ...
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 px-5 py-5 border-b border-sidebar-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center w-8 h-8 rounded-lg bg-primary text-primary-foreground shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Compass, { className: "h-4.5 w-4.5", strokeWidth: 2.5 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold font-display text-base text-sidebar-foreground leading-none", children: "Career" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold font-display text-base text-primary leading-none", children: [
              " ",
              "Compass"
            ] })
          ] })
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                {
                  ...
                  className: cn(
                    ...
                    isActive ? "bg-primary/10 text-primary" : "text-sidebar-foreground hover:bg-muted hover:text-foreground"
                  ),
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      item.icon,
        ...
        isAuthenticated && milestoneCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "bg-sidebar-border" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4", "data-ocid": "sidebar.progress_panel", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-2", children: "Roadmap Progress" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ProgressBar,
              {
                value: progressPct,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "bg-sidebar-border" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-4", children: isInitializing ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-9 bg-muted rounded-lg animate-pulse" }) : isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-2 rounded-lg bg-muted", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "h-3.5 w-3.5 text-muted-foreground shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground truncate font-mono", children: [
              principalId == null ? void 0 : principalId.slice(0, 10),
              "…"
            ] })
          ] }),
...
const mobileNavItems = [
  { to: "/", label: "Home", icon: House, ocid: "mobile_nav.home_link" },
  {
    to: "/assessment",
    label: "Assess",
    icon: ClipboardList,
...
function Layout({ children, className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen overflow-hidden bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex md:flex-col md:shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { className: "h-full" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "main",
      {
        className: cn(
...
export {
  ...
  useSaveProfile as d,
  ue as e,
  useCareerRecommendations as f,
  useSelectCareer as g,
  useCareerPath as h,
  useRoadmap as i,
  useUserProgress as j,
  useToggleMilestone as k,
