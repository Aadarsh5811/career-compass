import { r as reactExports, j as jsxRuntimeExports, u as useNavigate } from "./index-BYoSv118.js";
import { c as createLucideIcon, u as useAuth, L as Layout, C as Compass, B as Button, a as ClipboardList, b as Lightbulb, M as MapPin } from "./Layout-BlufahZe.js";
import { C as Card, a as CardHeader, b as CardContent } from "./card-Bl25nIOz.js";
...
const features = [
  {
    ...
    description: "Tell us your skills, interests, and goals. Our assessment pinpoints the careers that fit you best.",
    color: "text-primary",
    bg: "bg-primary/10",
  ...
  },
  {
    ...
    description: "Get ranked career matches with match scores, skill gap analysis, and salary benchmarks.",
  ...
  },
  {
    ...
    description: "Step-by-step milestones: what to learn, which projects to build, and in what order.",
  ...
  },
  {
    ...
    description: "Hand-picked courses, videos, and articles — free and paid — for every milestone.",
    color: "text-chart-4",
    bg: "bg-chart-4/10",
  ...
  },
  {
    ...
    description: "Compare your current skills against what's required and focus your learning where it matters.",
    color: "text-primary",
    bg: "bg-primary/10",
  ...
  },
  {
    ...
    description: "Track completed milestones, skills acquired, and estimated time to job-ready.",
    color: "text-secondary",
    bg: "bg-secondary/10",
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              "aria-hidden": true,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-24 -left-24 w-[500px] h-[500px] rounded-full bg-primary/5 blur-3xl" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-24 -right-24 w-[400px] h-[400px] rounded-full bg-secondary/5 blur-3xl" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] rounded-full bg-accent/5 blur-2xl" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-semibold mb-6", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Compass, { className: "h-3.5 w-3.5" }),
                  "Smart Career Guidance Platform"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-extrabold text-4xl md:text-5xl lg:text-6xl text-foreground leading-[1.1] tracking-tight mb-4", children: [
                  "Find Your ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Career Path." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                  "Execute the Plan."
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground leading-relaxed mb-8 max-w-xl mx-auto", children: "Stop guessing. Career Compass analyzes your skills and interests to surface the best career options — then hands you a step-by-step roadmap to get there." }),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl md:text-3xl text-foreground mb-2", children: "How It Works" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-md mx-auto", children: "From confused to job-ready in four clear steps." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4", children: steps.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-primary/10 flex items-center justify-center mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-primary", children: i + 1 }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold font-display text-sm text-foreground mb-1", children: step.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: step.sub })
              ]
            },
            step.label
          )) })
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              className: "text-center mb-10",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl md:text-3xl text-foreground mb-2", children: "Everything You Need" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-md mx-auto", children: "Not just suggestions — a complete system to get you from interest to employed." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: features.map((feat, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 20 },
              whileInView: { opacity: 1, y: 0 },
              ...
              "data-ocid": feat.ocid,
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "h-full hover:shadow-card transition-smooth border-border group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-2 pt-5 px-5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(feat.icon, { className: `h-5 w-5 ${feat.color}` })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold font-display text-sm text-foreground", children: feat.title })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-5 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: feat.description }) })
              ] })
            },
            feat.title
          )) })
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl md:text-3xl text-primary-foreground mb-3", children: "Ready to find your direction?" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-sm mb-6", children: "Take the 5-minute assessment and get your personalized career roadmap today." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  size: "lg",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border px-6 py-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
      "© ",
